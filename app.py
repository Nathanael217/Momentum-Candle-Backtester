...
- If all engines agree AND no conflicts: HIGH confidence TRADE
...
RATIONALE: [3 sentences max. Lead with the strongest factor for your verdict. Cite specific win rate, EV, ML%, and any conflict.]
                ...
                if _is_perp:
                    ...
                    if _deriv_cache_key not in st.session_state:
                        try:
                            ...
                            _fr = {"rate": 0.0, "ok": False}
                            _oi = {"oi_change_pct": 0.0, "ok": False}
