...
def _scanner_ai_verdict(sig: dict, ml: dict = None, bt: dict = None) -> dict:
    ...
    if bt and bt.get("error") is None:
        ...
        _b_sl     = _etp.get(_bkeys[1], 0) if _bkeys else 0
        _b_tp1    = _etp.get(_bkeys[2], 0) if _bkeys else 0
        _b_tp2    = _etp.get(_bkeys[3], 0) if _bkeys else 0
        _b_tp3    = _etp.get(_bkeys[4], 0) if _bkeys else 0
      ...
      <div style="color:#ccd6f6;">Price already >1R from aggressive entry without a retrace</div>
            ...
            if _bt_res or _ml_res:
                ...
                for _zn in ("Aggressive", "Standard", "Sniper"):
                    ...
                    _tp1_show      = _tp1_p if _ep else _fix_tp1
                    _tp2_show      = _tp2_p if _ep else _fix_tp2
                    _tp3_show      = _tp3_p if _ep else _fix_tp3
                ...
                if _best and _best_key:
                    ...
                    _b_tp1_px  = _b_tp1 if _bep else _b_fix_tp1
                    _b_tp2_px  = _b_tp2 if _bep else _b_fix_tp2
